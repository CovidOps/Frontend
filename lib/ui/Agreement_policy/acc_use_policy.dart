...
class MyTextPage extends StatelessWidget {
 ...
 13. Facilitating, aiding, or encouraging any of the above activities through the Mobile Application and Services.''',
            ...
            Container(
              ...
              margin: EdgeInsets.all(20.0),
              padding: EdgeInsets.all(12.0),
              child: Text("Security Abuse",style: TextStyle(color:Colors.black,fontSize:34,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
            ),
            Container(
              alignment: Alignment.centerLeft,
              margin: EdgeInsets.all(20.0),
  ...
  4.  Unauthorized scanning or monitoring of data on any network or system without proper authorization of the owner of the system or network.''',
            ...
            Container(
              ...
              margin: EdgeInsets.all(20.0),
              padding: EdgeInsets.all(12.0),
              child: Text("Service resources",style: TextStyle(color:Colors.black,fontSize:34,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
            ),
            Container(
              alignment: Alignment.centerLeft,
              margin: EdgeInsets.all(20.0),
  ...
  2.  Engaging in any other activities that degrade the usability and performance of the Mobile Application and Services.''',
            ...
            Container(
              ...
              margin: EdgeInsets.all(20.0),
              padding: EdgeInsets.all(12.0),
              child: Text("No spam policy",style: TextStyle(color:Colors.black,fontSize:34,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
            ),
            Container(
              alignment: Alignment.centerLeft,
              margin: EdgeInsets.all(20.0),
            ...
            Container(
              ...
              margin: EdgeInsets.all(20.0),
              padding: EdgeInsets.all(12.0),
              child: Text("Defamation and objectionable content",style: TextStyle(color:Colors.black,fontSize:34,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
            ),
            Container(
              alignment: Alignment.centerLeft,
              margin: EdgeInsets.all(20.0),
            ...
            Container(
              ...
              margin: EdgeInsets.all(20.0),
              padding: EdgeInsets.all(12.0),
              child: Text("Copyrighted content",style: TextStyle(color:Colors.black,fontSize:34,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
            ),
            Container(
              alignment: Alignment.centerLeft,
              margin: EdgeInsets.all(20.0),
            ...
            Container(
              ...
              margin: EdgeInsets.all(20.0),
              padding: EdgeInsets.all(12.0),
              child: Text("Security",style: TextStyle(color:Colors.black,fontSize:34,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
            ),
            Container(
              alignment: Alignment.centerLeft,
              margin: EdgeInsets.all(20.0),
            ...
            Container(
              ...
              margin: EdgeInsets.all(20.0),
              padding: EdgeInsets.all(12.0),
              child: Text("Enforcement",style: TextStyle(color:Colors.black,fontSize:34,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
            ),
            Container(
              alignment: Alignment.centerLeft,
              margin: EdgeInsets.all(20.0),
  ...
  4. A failure to respond to an email from our abuse team within 2 days, or as otherwise specified in the communication to you, may result in the suspension or termination of your account.''',
            ...
            Container(
              ...
              margin: EdgeInsets.all(20.0),
              padding: EdgeInsets.all(12.0),
              child: Text("Reporting violations",style: TextStyle(color:Colors.black,fontSize:34,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
            ),
            Container(
              alignment: Alignment.centerLeft,
              margin: EdgeInsets.all(20.0),
            ...
            Container(
              ...
              margin: EdgeInsets.all(20.0),
              padding: EdgeInsets.all(12.0),
              child: Text('''If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to it, you may do so via the contact form or send an email to aman.19je0108@mech.iitism.ac.in. This document was last updated on May 5, 2021''',
                maxLines: 20,
                textAlign: TextAlign.left,
                style: TextStyle(color:Colors.black,fontSize:26),),
            ),
